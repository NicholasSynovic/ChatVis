...
reader = ExodusIIReader(
    FileName="/Users/tanwimallick/Documents/Paraview/generated_code/disk.ex2"
)
reader.UpdatePipeline()

# Tracing streamlines of the V data array seeded from a default point cloud
streamTracer = StreamTracer(
    registrationName="StreamTracer1", Input=reader, SeedType="Point Cloud"
)
...
SaveScreenshot(
    "/Users/tanwimallick/Documents/Paraview/generated_code/stream-glyph-screenshot.png",
    renderView,
