...
# read the input data
ml100vtk = LegacyVTKReader(
    registrationName="ml-100.vtk",
    FileNames=["/home/nicholas/Documents/projects/ChatVis/data/ml-100.vtk"],
)
...
# SaveScreenshot('/Users/tpeterka/collaborations/tanwi/examples/ml-iso/ml-iso-screenshot.png', renderView, ImageResolution=[1920, 1080])
