...
parser = argparse.ArgumentParser(
    description="dir-image-pairs.py </path/to/image_directory> </path/to/ground_truth_image_directory>"
)
...
# compute metrics
avg_ssim, avg_psnr, avg_lpips = average_metrics(
    Path(args.image_path), Path(args.gt_image_path)
)
