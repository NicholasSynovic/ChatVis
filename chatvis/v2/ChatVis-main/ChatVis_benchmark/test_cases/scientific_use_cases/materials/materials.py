...
ground_truthvtr = XMLRectilinearGridReader(
    registrationName="ground_truth.vtr", FileName=["neg10_ground_truth.vtr"]
)
...
cellDatatoPointData2 = CellDatatoPointData(
    registrationName="CellDatatoPointData2", Input=ground_truthvtr
)
...
# create a new 'XML Rectilinear Grid Reader'
predictionvtr = XMLRectilinearGridReader(
    registrationName="prediction.vtr", FileName=["neg10_prediction.vtr"]
)
...
cellDatatoPointData1 = CellDatatoPointData(
    registrationName="CellDatatoPointData1", Input=predictionvtr
)
